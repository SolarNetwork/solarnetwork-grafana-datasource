...
import { SolarNetworkDataSourceOptions, SolarNetworkSecureJsonData } from '../src/types';
...
test('"Save & test" should be successful when configuration is valid', async ({
  ...
  const ds = await readProvisionedDataSource<SolarNetworkDataSourceOptions, SolarNetworkSecureJsonData>({ fileName: 'datasources.yml' });
